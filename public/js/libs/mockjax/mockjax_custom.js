		...
		var process = (function(that) {
			return function() {
				return (function() {
					...
					/*My addition to log mocked response objects - brettj*/
					console.log( mockHandler );
					console.log( origSettings );
					var responseBody = '';
					if ( typeof mockHandler.responseText == 'object' ) {
						responseBody = JSON.stringify( mockHandler.responseText );
					} else if ( typeof mockHandler.responseText == 'string' ) {
						responseBody = mockHandler.responseText;
					}
					
					var html = "<div class='mocked-response-body'>";
					if ( origSettings.data ) {
						html = '<div class="mocked-response-body"><em>Request:</em> ' + JSON.stringify( origSettings.data ) + "</div><div class='mocked-response-body'><em>Response:</em> ";
					}
					html += responseBody + "</div>";
					
					$.jGrowl(html, {
						header: 'MOCK: ' + mockHandler.type + " " + mockHandler.url + " " + mockHandler.status,
